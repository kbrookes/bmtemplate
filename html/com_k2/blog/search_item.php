...
<article class="itemlistItemView blogSearchItem <?php echo ($this->item->featured) ? ' itemlistItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>" itemscope itemtype="http://schema.org/Article">
